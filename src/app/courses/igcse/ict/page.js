...
export default function IGCSEICTPage() {
  return (
    <main className="bg-white text-black min-h-screen font-sans">
      ...
      <section
        ...
        style={{ backgroundImage: "url('/images/courses/IGCSE ICT.jpg')" }}
      >
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          <p className="text-lg lg:text-xl text-white mt-4 drop-shadow-md animate-fade-in">
            International General Certificate of Secondary Education – Information and Communication Technology
          </p>
        </div>
      </section>
      ...
      <section className="max-w-5xl mx-auto mb-16 px-6">
        ...
        <p className="text-gray-700 leading-relaxed text-lg">
          Our IGCSE ICT course equips students with essential digital skills and a deep understanding of how technology shapes modern society.
          Designed with a balanced mix of theory and hands-on application, this course prepares learners to use ICT responsibly, effectively, and creatively.
        </p>
      </section>
      ...
      <section className="max-w-5xl mx-auto mb-16 px-6">
        ...
        <ul className="text-gray-700 leading-relaxed space-y-2 text-lg">
          {[
            ...
            'ICT Applications (e.g., Education, Healthcare, Business)',
            'Spreadsheets and Databases',
            'Document Production and Presentations',
            'Web Authoring (Including HTML)',
...
<section className="max-w-6xl mx-auto px-6 sm:px-10 mb-24">
  ...
  <div className="flex flex-col md:flex-row items-center bg-white rounded-3xl shadow-xl overflow-hidden">
    ...
    <div className="w-full md:w-2/3 px-6 py-8 md:py-10 md:px-10">
      <h3 className="text-2xl sm:text-3xl font-bold text-yellow-600 mb-2">
        Ms. Madara Wedhage
      </h3>
      <p className="text-gray-700 font-medium text-lg mb-3">
        Senior ICT Educator • Over 10 Years of Teaching Excellence
      </p>
      <p className="text-gray-600 leading-relaxed text-base mb-6 max-w-2xl">
        Ms. Madara is a passionate, Cambridge-certified ICT educator with over a decade of experience empowering students across the globe. Her dynamic and blended approach to teaching ensures every learner builds both competence and confidence — from foundational learning to exam preparedness.
      </p>
      ...
      <ul className="space-y-3 text-gray-800">
        <li className="flex items-start gap-3">
          ...
          <span>Cambridge Certified ICT Instructor</span>
        </li>
        <li className="flex items-start gap-3">
          <HiCheckCircle className="text-yellow-500 mt-1 text-lg" />
          <span>Over 1,000 Students Taught Worldwide</span>
        </li>
        <li className="flex items-start gap-3">
          <HiCheckCircle className="text-yellow-500 mt-1 text-lg" />
          <span>Focuses on Exam Strategy, Digital Fluency & Student Confidence</span>
        </li>
      </ul>
    </div>
  </div>
      ...
      <section className="text-center mt-24 mb-20 px-6">
        ...
        <p className="text-gray-700 text-lg max-w-2xl mx-auto mb-6">
          Unlock your future with interactive lessons, real-world projects, and expert guidance all in one comprehensive ICT course.
        </p>
